...
func TestClient_Error(t *testing.T) {
	...
	t.Run("Do", func(t *testing.T) {
		...
		if _, err := c.GetBlocks(ctx, uuid.MustParse("96245c8f-1784-44a4-82ad-1941127c3ec3"), &notion.GetBlocksParams{
			PageSize:    100,
...
func TestClient_VCR(t *testing.T) {
	...
	t.Run("2025-02-08", func(t *testing.T) {
		replay(t, "vcr/2025-02-08")
	...
	t.Run("2025-02-09", func(t *testing.T) {
		replay(t, "vcr/2025-02-09")
	...
	t.Run("2025-02-12", func(t *testing.T) {
		replay(t, "vcr/2025-02-12")
	...
	t.Run("2025-02-13", func(t *testing.T) {
		replay(t, "vcr/2025-02-13")
	...
	t.Run("2025-02-14", func(t *testing.T) {
		replay(t, "vcr/2025-02-14")
	...
	t.Run("2025-02-15", func(t *testing.T) {
		replay(t, "vcr/2025-02-15")
		...
		{
			res, err := c.GetBlocks(ctx, uuid.MustParse("96245c8f-1784-44a4-82ad-1941127c3ec3"), nil)
			if err != nil {
				t.Fatal(err)
			} else if res == nil {
				t.Fatal("result is nil")
		...
		{
			res, err := c.GetBlocks(ctx, uuid.MustParse("96245c8f-1784-44a4-82ad-1941127c3ec3"), &notion.GetBlocksParams{PageSize: 101})
			if err != nil {
				t.Fatal(err)
			} else if res == nil {
				t.Fatal("result is nil")
		...
		{
			res, err := c.GetBlocks(ctx, uuid.MustParse("96245c8f-1784-44a4-82ad-1941127c3ec3"), &notion.GetBlocksParams{PageSize: 10})
			if err != nil {
				t.Fatal(err)
			} else if res == nil {
				t.Fatal("result is nil")
	...
	t.Run("2025-02-16", func(t *testing.T) {
		replay(t, "vcr/2025-02-16")
		...
		{
			res, err := c.GetBlocks(ctx, uuid.MustParse("96245c8f-1784-44a4-82ad-1941127c3ec3"), &notion.GetBlocksParams{
				PageSize:    10,
				StartCursor: uuid.MustParse("d05aa478-397e-4954-b694-b7c1c6c78956"),
			})
			if err != nil {
