...
func (e BlockType) Valid() bool {
	switch e {
	case BlockTypeParagraph, BlockTypeHeading1, BlockTypeHeading2, BlockTypeHeading3, BlockTypeBulletedListItem, BlockTypeNumberedListItem, BlockTypeToDo, BlockTypeToggle, BlockTypeChildPage, BlockTypeChildDatabase, BlockTypeEmbed, BlockTypeImage, BlockTypeVideo, BlockTypeFile, BlockTypePdf, BlockTypeBookmark, BlockTypeCallout, BlockTypeQuote, BlockTypeEquation, BlockTypeDivider, BlockTypeTableOfContents, BlockTypeColumn, BlockTypeColumnList, BlockTypeLinkPreview, BlockTypeSyncedBlock, BlockTypeTemplate, BlockTypeLinkToPage, BlockTypeTable, BlockTypeTableRow, BlockTypeCode, BlockTypeBreadcrumb, BlockTypeAudio, BlockTypeUnsupported:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the CodeLanguage enum.
func (e CodeLanguage) Valid() bool {
	switch e {
	case CodeLanguageAbap, CodeLanguageArduino, CodeLanguageBash, CodeLanguageBasic, CodeLanguageC, CodeLanguageClojure, CodeLanguageCoffeescript, CodeLanguageCPlusPlus, CodeLanguageCSharp, CodeLanguageCSS, CodeLanguageDart, CodeLanguageDiff, CodeLanguageDocker, CodeLanguageElixir, CodeLanguageElm, CodeLanguageErlang, CodeLanguageFlow, CodeLanguageFortran, CodeLanguageFSharp, CodeLanguageGherkin, CodeLanguageGlsl, CodeLanguageGo, CodeLanguageGraphql, CodeLanguageGroovy, CodeLanguageHaskell, CodeLanguageHTML, CodeLanguageJava, CodeLanguageJavascript, CodeLanguageJSON, CodeLanguageJulia, CodeLanguageKotlin, CodeLanguageLatex, CodeLanguageLess, CodeLanguageLisp, CodeLanguageLivescript, CodeLanguageLua, CodeLanguageMakefile, CodeLanguageMarkdown, CodeLanguageMarkup, CodeLanguageMatlab, CodeLanguageMermaid, CodeLanguageNix, CodeLanguageObjectiveC, CodeLanguageOcaml, CodeLanguagePascal, CodeLanguagePerl, CodeLanguagePhp, CodeLanguagePlainText, CodeLanguagePowershell, CodeLanguageProlog, CodeLanguageProtobuf, CodeLanguagePython, CodeLanguageR, CodeLanguageReason, CodeLanguageRuby, CodeLanguageRust, CodeLanguageSass, CodeLanguageScala, CodeLanguageScheme, CodeLanguageScss, CodeLanguageShell, CodeLanguageSQL, CodeLanguageSwift, CodeLanguageTypescript, CodeLanguageVbDotNet, CodeLanguageVerilog, CodeLanguageVhdl, CodeLanguageVisualBasic, CodeLanguageWebassembly, CodeLanguageXML, CodeLanguageYaml, CodeLanguageJavaCCPlusPlusCSharp:
		return true
	default:
		return false
	}
...
func (e Color) Valid() bool {
	switch e {
	case ColorDefault, ColorGray, ColorBrown, ColorOrange, ColorYellow, ColorGreen, ColorBlue, ColorPurple, ColorPink, ColorRed, ColorGrayBackground, ColorBrownBackground, ColorOrangeBackground, ColorYellowBackground, ColorGreenBackground, ColorBlueBackground, ColorPurpleBackground, ColorPinkBackground, ColorRedBackground:
		return true
	default:
		return false
	}
...
func (e FileType) Valid() bool {
	switch e {
	case FileTypeFile, FileTypeExternal:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the IconType enum.
func (e IconType) Valid() bool {
	switch e {
	case IconTypeEmoji, IconTypeFile, IconTypeExternal:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the LinkToPageType enum.
func (e LinkToPageType) Valid() bool {
	switch e {
...
// Valid indicates whether the value is a known member of the MentionType enum.
func (e MentionType) Valid() bool {
	switch e {
	case MentionTypeLinkMention:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the ParentType enum.
func (e ParentType) Valid() bool {
	switch e {
	case ParentTypePageID, ParentTypeWorkspace, ParentTypeBlockID, ParentTypeDatabaseID:
		return true
	default:
		return false
	}
...
func (e PropertyType) Valid() bool {
	switch e {
	case PropertyTypeRichText, PropertyTypeNumber, PropertyTypeSelect, PropertyTypeStatus, PropertyTypeMultiSelect, PropertyTypeDate, PropertyTypeFormula, PropertyTypeRelation, PropertyTypeRollup, PropertyTypeTitle, PropertyTypePeople, PropertyTypeFiles, PropertyTypeCheckbox, PropertyTypeURL, PropertyTypeEmail, PropertyTypePhoneNumber, PropertyTypeCreatedTime, PropertyTypeCreatedBy, PropertyTypeLastEditedTime, PropertyTypeLastEditedBy, PropertyTypeButton:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the SyncedFromType enum.
func (e SyncedFromType) Valid() bool {
	switch e {
...
func (e UserType) Valid() bool {
	switch e {
	case UserTypePerson, UserTypeBot:
		return true
	default:
		return false
	}
